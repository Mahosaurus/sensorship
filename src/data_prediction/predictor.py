...
from ml.ml_artifacts.temperature_lstm_model import LSTMModel as TEMPERATURE_LSTM
from ml.ml_artifacts.humidity_lstm_model import LSTMModel as HUMIDITY_LSTM
...
class Predictor():
    ...
    def load_model(flavour):
        path_to_model = os.path.join(get_repo_root(),"ml", "ml_artifacts", f"{flavour}_lstm.model")
        path_to_preproc = os.path.join(get_repo_root(), "ml", "ml_artifacts", f"{flavour}_preproc.joblib")
