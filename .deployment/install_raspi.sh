...
libncursesw5-dev xz-utils tk-dev libxml2-dev libxmlsec1-dev libffi-dev liblzma-dev libopenblas-dev
...
pyenv install -v 3.9.15 -s
pyenv global 3.9.15

#######################################
# Install venv
#######################################
python -m venv venv_sensor
...
source ./venv_sensor/bin/activate
